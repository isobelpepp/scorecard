...
describe('Doubled contracts - underbid, VULNERABLE', () => {
  ...
  it('doubles the score for Major suits and adds 200 for every overtrick made', () => {
    ...
    let spadesScore = spades.scoring('They', 'Spades', 2, 6, 'doubled', true)
  ...
  it('doubles the score for Minor suits and adds 200 above for every overtrick', () => {
    ...
    let clubsScore = clubs.scoring('They', 'Clubs', 1, 7, 'doubled', true)
...
describe('Doubled and DEFEATED contracts, VULNERABLE', () => {
  it('200 for 1st trick, 300 for every trick after that', () => {
    ...
    let heartsScore = hearts.scoring('They', 'Hearts', 6, 2, 'doubled', true)
    let spades = new Scoring()
    let spadesScore = spades.scoring('They', 'Spades', 6, 3, 'doubled', true)
    let diamonds = new Scoring()
    let diamondsScore = diamonds.scoring('They', 'Diamonds', 4, 2, 'doubled', true)
    let clubs = new Scoring()
    let clubsScore = clubs.scoring('They', 'Clubs', 2, 1, 'doubled', true)
